...
import type { TreeNode, CollectionItem } from '../../lib/types';
...
function buildTree(items: CollectionItem[]): TreeNode[] {
  ...
  for (const item of items) {
    ...
    for (let i = 0; i < parts.length; i++) {
      ...
      const newNode: TreeNode = {
        ...
        isDir: !isFile,
        children: [],
        tags: isFile ? item.tags : undefined,
      };
...
function filterTree(nodes: TreeNode[], q: string, activeTags: Set<string>): TreeNode[] {
...
function collectTags(items: CollectionItem[]): { tag: string; count: number }[] {
