...
// ─── Bench schema constants — format-level validation data ───
// These live in the parser because they define what's valid in .gctf format.
...
/// Minimal source config for YAML deserialization in BENCH section validation.
/// Only fields needed for validation: file existence check + cycle detection.
